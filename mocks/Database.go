...
func (_m *Database) Aggregate(ctx context.Context, pipeline interface{}, opts ...*options.AggregateOptions) (*mongo.Cursor, error) {
...
func (_c *Database_Aggregate_Call) Return(_a0 *mongo.Cursor, _a1 error) *Database_Aggregate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Database_Aggregate_Call) RunAndReturn(run func(context.Context, interface{}, ...*options.AggregateOptions) (*mongo.Cursor, error)) *Database_Aggregate_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *Database_Collection_Call) Return(_a0 mongodb.Collection) *Database_Collection_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Database_Collection_Call) RunAndReturn(run func(string, ...*options.CollectionOptions) mongodb.Collection) *Database_Collection_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Database) ListCollections(ctx context.Context, filter interface{}, opts ...*options.ListCollectionsOptions) (*mongo.Cursor, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_c *Database_ListCollections_Call) Return(_a0 *mongo.Cursor, _a1 error) *Database_ListCollections_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Database_ListCollections_Call) RunAndReturn(run func(context.Context, interface{}, ...*options.ListCollectionsOptions) (*mongo.Cursor, error)) *Database_ListCollections_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Database) RunCommand(ctx context.Context, runCommand interface{}, opts ...*options.RunCmdOptions) *mongo.SingleResult {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_c *Database_RunCommand_Call) Return(_a0 *mongo.SingleResult) *Database_RunCommand_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Database_RunCommand_Call) RunAndReturn(run func(context.Context, interface{}, ...*options.RunCmdOptions) *mongo.SingleResult) *Database_RunCommand_Call {
	_c.Call.Return(run)
	return _c
}

// RunCommandCursor provides a mock function with given fields: ctx, runCommand, opts
func (_m *Database) RunCommandCursor(ctx context.Context, runCommand interface{}, opts ...*options.RunCmdOptions) (*mongo.Cursor, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_c *Database_RunCommandCursor_Call) Return(_a0 *mongo.Cursor, _a1 error) *Database_RunCommandCursor_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Database_RunCommandCursor_Call) RunAndReturn(run func(context.Context, interface{}, ...*options.RunCmdOptions) (*mongo.Cursor, error)) *Database_RunCommandCursor_Call {
	_c.Call.Return(run)
	return _c
}

// Watch provides a mock function with given fields: ctx, pipeline, opts
func (_m *Database) Watch(ctx context.Context, pipeline interface{}, opts ...*options.ChangeStreamOptions) (*mongo.ChangeStream, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_c *Database_Watch_Call) Return(_a0 *mongo.ChangeStream, _a1 error) *Database_Watch_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Database_Watch_Call) RunAndReturn(run func(context.Context, interface{}, ...*options.ChangeStreamOptions) (*mongo.ChangeStream, error)) *Database_Watch_Call {
	_c.Call.Return(run)
	return _c
}
